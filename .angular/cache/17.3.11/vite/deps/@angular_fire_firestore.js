import {
  AuthInstances
} from "./chunk-NHV74UXW.js";
import "./chunk-Z3UPIM7T.js";
import {
  Component,
  FirebaseError,
  LogLevel,
...
import {
  ...
  where,
  writeBatch
} from "./chunk-MXUS34F7.js";
import "./chunk-6O6QQTA7.js";
import {
  FirebaseApp,
  FirebaseApps
...
(function() {
  ...
  function D2(f, a) {
    ...
    if (C2(f))
      return new H(w, w);
    if (B2(f))
      return a = D2(x2(f), a), new H(x2(a.g), x2(a.h));
    if (B2(a))
      return a = D2(f, x2(a)), new H(x2(a.g), a.h);
    if (30 < f.g.length) {
      if (B2(f) || B2(a))
...
var Timestamp2 = class _Timestamp {
  ...
  constructor(e, t) {
    if (this.seconds = e, this.nanoseconds = t, t < 0)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + t);
    if (t >= 1e9)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + t);
    if (e < F)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "Timestamp seconds out of range: " + e);
    if (e >= 253402300800)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "Timestamp seconds out of range: " + e);
  }
  /**
...
var ResourcePath = class _ResourcePath extends BasePath {
  ...
  static fromString(...e) {
    ...
    for (const n of e) {
      if (n.indexOf("//") >= 0)
        throw new FirestoreError2(C.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
...
var FieldPath$12 = class _FieldPath$1 extends BasePath {
  ...
  static fromServerFormat(e) {
    ...
    const __PRIVATE_addCurrentSegment = () => {
      if (0 === n.length)
        throw new FirestoreError2(C.INVALID_ARGUMENT, `Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
      t.push(n), n = "";
    };
    let i = false;
    for (; r < e.length; ) {
      ...
      if ("\\" === t2) {
        if (r + 1 === e.length)
          throw new FirestoreError2(C.INVALID_ARGUMENT, "Path has trailing escape character: " + e);
        const t3 = e[r + 1];
        if ("\\" !== t3 && "." !== t3 && "`" !== t3)
          throw new FirestoreError2(C.INVALID_ARGUMENT, "Path has invalid escape sequence: " + e);
        n += t3, r += 2;
      } else
        "`" === t2 ? (i = !i, r++) : "." !== t2 || i ? (n += t2, r++) : (__PRIVATE_addCurrentSegment(), r++);
    }
    if (__PRIVATE_addCurrentSegment(), i)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "Unterminated ` in path: " + e);
...
function fromName(e, t) {
  ...
  if (n.get(1) !== e.databaseId.projectId)
    throw new FirestoreError2(C.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + e.databaseId.projectId);
  if (n.get(3) !== e.databaseId.database)
    throw new FirestoreError2(C.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + e.databaseId.database);
            ...
            case ErrorCode.HTTP_ERROR:
              ...
              if (__PRIVATE_logDebug(Wt, `RPC '${e}' ${i} failed with status:`, n2, "response text:", _.getResponseText()), n2 > 0) {
                ...
                if (t3 && t3.status && t3.message) {
                  ...
                  o(new FirestoreError2(C.UNKNOWN, "Server responded with status " + _.getStatus()));
              } else
...
var __PRIVATE_DatastoreImpl = class extends Datastore {
  ...
  M_() {
    if (this.F_)
      throw new FirestoreError2(C.FAILED_PRECONDITION, "The client has already been terminated.");
  }
...
function __PRIVATE_wrapInUserErrorIfRecoverable(e, t) {
  if (__PRIVATE_logError("AsyncQueue", `${t}: ${e}`), __PRIVATE_isIndexedDbTransactionError(e))
    return new FirestoreError2(C.UNAVAILABLE, `${t}: ${e}`);
  throw e;
}
  ...
  return __async(this, null, function* () {
    if (!e._offlineComponents)
      if (e._uninitializedComponentsProvider) {
        ...
        __PRIVATE_logDebug(Yt, "Using default OfflineComponentProvider"), yield __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
...
function __PRIVATE_validateIsNotUsedTogether2(e, t, n, r) {
  if (true === t && true === r)
    throw new FirestoreError2(C.INVALID_ARGUMENT, `${e} and ${n} cannot be used together.`);
}
...
function __PRIVATE_cast2(e, t) {
  ...
  (e = e._delegate), !(e instanceof t)) {
    if (t.name === e.constructor.name)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
    {
...
var FirestoreSettingsImpl = class {
  constructor(e) {
    ...
    if (void 0 === e.host) {
      if (void 0 !== e.ssl)
        throw new FirestoreError2(C.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
    ...
    if (this.credentials = e.credentials, this.ignoreUndefinedProperties = !!e.ignoreUndefinedProperties, this.localCache = e.localCache, void 0 === e.cacheSizeBytes)
      ...
      if (-1 !== e.cacheSizeBytes && e.cacheSizeBytes < Dt)
        throw new FirestoreError2(C.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    ...
    __PRIVATE_validateIsNotUsedTogether2("experimentalForceLongPolling", e.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", e.experimentalAutoDetectLongPolling), this.experimentalForceLongPolling = !!e.experimentalForceLongPolling, this.experimentalForceLongPolling ? this.experimentalAutoDetectLongPolling = false : void 0 === e.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = true : (
      ...
      if (void 0 !== e2.timeoutSeconds) {
        if (isNaN(e2.timeoutSeconds))
          throw new FirestoreError2(C.INVALID_ARGUMENT, `invalid long polling timeout: ${e2.timeoutSeconds} (must not be NaN)`);
        if (e2.timeoutSeconds < 5)
          throw new FirestoreError2(C.INVALID_ARGUMENT, `invalid long polling timeout: ${e2.timeoutSeconds} (minimum allowed value is 5)`);
        if (e2.timeoutSeconds > 30)
          throw new FirestoreError2(C.INVALID_ARGUMENT, `invalid long polling timeout: ${e2.timeoutSeconds} (maximum allowed value is 30)`);
      }
...
var Firestore$1 = class {
  ...
  get app() {
    if (!this._app)
      throw new FirestoreError2(C.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
    return this._app;
  }
  get _initialized() {
  ...
  _setSettings(e) {
    if (this._settingsFrozen)
      throw new FirestoreError2(C.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
...
var FieldPath2 = class {
  ...
  constructor(...e) {
    for (let t = 0; t < e.length; ++t)
      if (0 === e[t].length)
        throw new FirestoreError2(C.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
...
var GeoPoint2 = class {
  ...
  constructor(e, t) {
    if (!isFinite(e) || e < -90 || e > 90)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + e);
    if (!isFinite(t) || t < -180 || t > 180)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + t);
...
function __PRIVATE_validateHasExplicitOrderByForLimitToLast(e) {
  if ("L" === e.limitType && 0 === e.explicitOrderBy.length)
    throw new FirestoreError2(C.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var QuerySnapshot2 = class {
  ...
  docChanges(e = {}) {
    ...
    if (t && this._snapshot.excludesMetadataChanges)
      throw new FirestoreError2(C.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
  ...
  !function __PRIVATE_setSDKVersion(e2) {
    ...
    const i = e2.getProvider("app").getImmediate(), s = new Firestore(new __PRIVATE_FirebaseAuthCredentialsProvider(e2.getProvider("auth-internal")), new __PRIVATE_FirebaseAppCheckTokenProvider(i, e2.getProvider("app-check-internal")), function __PRIVATE_databaseIdFromApp(e3, t2) {
      if (!Object.prototype.hasOwnProperty.apply(e3.options, ["projectId"]))
        throw new FirestoreError2(C.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
